...
export default function ExplainConnect({ onClick }: { onClick: () => void }) {
  return (
    <div className="flex flex-col  px-6 md:pb-10 bg-secondary md:border border-tertiary min-h-[calc(100dvh-80px)] md:min-h-0 md:min-w-[600px] md:max-w-[650px] md:rounded-md border-gray shadow-lg">
