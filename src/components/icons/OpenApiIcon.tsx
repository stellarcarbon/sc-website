...
export default function OpenAPILogo(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      className="bg-white"
      id="Layer_1"
    ...
    >
      ...
      <g>
        <g>
          ...
          <path
            className="cls-6"
            d="M116.53,227.53h0c.07-.04,.13-.07,.2-.11h0c-.07,.03-.13,.07-.2,.11Z"
          />
          <polygon
            className="cls-6"
            points="116.49 227.56 116.5 227.55 116.5 227.55 116.49 227.56"
          />
          <polygon
            className="cls-6"
            points="116.48 227.56 116.49 227.56 116.45 227.5 116.48 227.56"
          />
          <path
            className="cls-6"
            d="M116.5,227.55h0s.02-.01,.03-.02h0s-.02,.01-.03,.02Z"
          />
          <polygon
            className="cls-6"
          ...
          <path
            className="cls-6"
            d="M116.49,227.56s0,0,0,0h0s0,0,.01,0h0s0,0,0,0Z"
          />
          <path
            className="cls-6"
            d="M116.53,227.53c.07-.04,.13-.07,.2-.11-.07,.04-.13,.07-.2,.11h0Z"
          />
          <polygon
            className="cls-6"
            points="116.73 227.42 116.73 227.41 116.73 227.41 116.73 227.42"
          />
          <rect
            className="cls-6"
            x="116.47"
            ...
            width="0"
            height="0"
            transform="translate(-106.67 102.83) rotate(-33.69)"
          />
          <polygon
            className="cls-6"
            points="116.46 227.57 116.46 227.57 116.47 227.57 116.46 227.57"
          />
          <polygon
            className="cls-6"
      ...
      <g>
        <path
          className="cls-3"
          d="M155.91,184.53c0-14.78,10.81-25.37,25.67-25.37s25.59,10.59,25.59,25.37-10.81,25.37-25.59,25.37-25.67-10.59-25.67-25.37Zm40.52,0c0-9.19-5.81-16.11-14.86-16.11s-14.93,6.91-14.93,16.11,5.81,16.11,14.93,16.11,14.86-6.99,14.86-16.11Z"
        />
        <path
          className="cls-3"
          d="M212.68,209.02v-49.06h22.95c10.66,0,16.47,7.21,16.47,15.81s-5.88,15.74-16.47,15.74h-12.5v17.5h-10.44Zm28.76-33.24c0-4.12-3.16-6.62-7.28-6.62h-11.03v13.16h11.03c4.12,0,7.28-2.5,7.28-6.55Z"
        />
        <path
          className="cls-3"
          d="M256.81,209.02v-49.06h34.72v9.19h-24.27v10.3h23.76v9.19h-23.76v11.18h24.27v9.19h-34.72Z"
        />
        <path
          className="cls-3"
          d="M331.68,209.02l-23.39-31.99v31.99h-10.45v-49.06h10.74l22.73,30.82v-30.82h10.44v49.06h-10.08Z"
        />
        <path
          className="cls-3"
          d="M386.45,209.02l-3.09-8.31h-21.03l-3.09,8.31h-11.84l18.9-49.06h13.09l18.9,49.06h-11.84Zm-13.61-38.61l-7.65,21.11h15.3l-7.65-21.11Z"
        />
        <path
          className="cls-3"
          d="M401.01,209.02v-49.06h22.95c10.66,0,16.47,7.21,16.47,15.81s-5.89,15.74-16.47,15.74h-12.5v17.5h-10.44Zm28.76-33.24c0-4.12-3.16-6.62-7.28-6.62h-11.03v13.16h11.03c4.12,0,7.28-2.5,7.28-6.55Z"
        />
        <path className="cls-3" d="M445.14,209.02v-49.06h10.44v49.06h-10.44Z" />
      </g>
    </svg>
  );
}
