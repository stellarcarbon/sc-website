...
export default function WalletConnectionInfoSmall() {
  ...
  return (
    <div
      className={` flex justify-center items-center gap-1 bg-darkest text-white border border-secondary rounded cursor-pointer md:hover:border-tertiary md:hover:bg-darker md:hover:text-white h-10 min-w-10 md:h-10 px-2`}
    >
      <img
