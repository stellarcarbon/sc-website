  ...
  return (
    <>
      ...
      <div className="bg-dalle bg-no-repeat bg-cover fixed top-0 left-0 w-screen h-[100dvh] flex items-center justify-center z-[200]">
        <div className="relative bg-primary mx-2 w-full md:w-[60%] lg:w-[60%] max-w-[600px] opacity-100 shadow-xl rounded-md border border-tertiary overflow-auto z-[2000]">
