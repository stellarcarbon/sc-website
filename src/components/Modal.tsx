  ...
  return (
    <>
      ...
      <div className="bg-dalle bg-no-repeat bg-cover fixed top-0 left-0 w-screen h-[100dvh] flex items-center justify-center z-[200]">
        <div className="relative bg-primary w-[87%] md:w-[60%] lg:w-[60%] min-h-[550px] h-[60%] lg:h-[70%] max-w-[600px] opacity-100 shadow-xl rounded-md border border-tertiary overflow-auto z-[2000]">
