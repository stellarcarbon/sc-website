    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <div className="flex flex-col items-center w-full">
        ...
        <div className="flex justify-center gap-8">
          <img
            onClick={() => {
              if (selectedWalletType === WalletType.ALBEDO) {
                setSelectedWalletType(null);
              } else {
                setSelectedWalletType(WalletType.ALBEDO);
              }
            }}
            className={`h-20 rounded-full p-2 hover:border hover:border-black cursor-pointer ${
              selectedWalletType === WalletType.ALBEDO
                ? "bg-slate-400 border border-black"
                : "bg-white"
            } `}
          ...
          <img
            onClick={() => {
              if (selectedWalletType === WalletType.XBULL) {
                setSelectedWalletType(null);
              } else {
                setSelectedWalletType(WalletType.XBULL);
              }
            }}
            className={`h-20 rounded-full p-2 hover:border hover:border-black cursor-pointer ${
              selectedWalletType === WalletType.XBULL
                ? "bg-slate-400 border border-black"
                : "bg-white"
            } `}
