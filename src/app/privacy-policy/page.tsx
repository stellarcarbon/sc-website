...
export default function PrivacyPolicyPage() {
  return (
    <main className="flex flex-col font-noto py-8 px-4 md:px-32 md:max-w-[1600px] md:mx-auto mt-[64px] md:mt-[80px]">
      <style jsx>{`
        h1 {
          font-size: 32px;
          font-weight: bold;
      ...
      <ul>
        <li>
          <p>
            ...
            <span>&nbsp;</span>means a unique account created for You to access
        ...
        <li>
          <p>
            ...
            <span>&nbsp;</span>(referred to as either “the Company”, “We”, “Us”
            or “Our” in this Agreement) refers to Carbonbank.
          </p>
        </li>
        <li>
          <p>
            <strong>Cookies</strong>
            <span>&nbsp;</span>are small files that are placed on Your computer,
        ...
        <li>
          <p>
            ...
            <span>&nbsp;</span>refers to: Queensland, Australia
          </p>
        </li>
        <li>
          <p>
            <strong>Device</strong>
            <span>&nbsp;</span>means any device that can access the Service such
        ...
        <li>
          <p>
            ...
            <span>&nbsp;</span>is any information that relates to an identified
        ...
        <li>
          <p>
            ...
            <span>&nbsp;</span>refers to the Website.
          </p>
        </li>
        <li>
          <p>
            <strong>Service Provider</strong>
            <span>&nbsp;</span>means any natural or legal person who processes
        ...
        <li>
          <p>
            ...
            <span>&nbsp;</span>refers to any website or any social network
        ...
        <li>
          <p>
            ...
            <span>&nbsp;</span>refers to data collected automatically, either
        ...
        <li>
          <p>
            <strong>You</strong>
            <span>&nbsp;</span>means the individual accessing or using the
      ...
      <ul>
        <li>
          ...
          <span>&nbsp;</span>A cookie is a small file placed on Your Device. You
        ...
        <li>
          ...
          <span>&nbsp;</span>Certain features of our Service may use local
        ...
        <li>
          ...
          <span>&nbsp;</span>Certain sections of our Service and our emails may
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            <span>&nbsp;</span>to manage Your registration as a user of the
        ...
        <li>
          <p>
            ...
            <span>&nbsp;</span>the development, compliance and undertaking of
        ...
        <li>
          <p>
            ...
            <span>&nbsp;</span>To contact You by email, telephone calls, SMS, or
        ...
        <li>
          <p>
            ...
            <span>&nbsp;</span>with news, special offers and general information
        ...
        <li>
          <p>
            ...
            <span>&nbsp;</span>To attend and manage Your requests to Us.
          </p>
        </li>
        <li>
          <p>
            <strong>For business transfers:</strong>
            <span>&nbsp;</span>We may use Your information to evaluate or
      ...
      <ul>
        <li>
          ...
          <span>&nbsp;</span>We may share Your personal information with Service
          Providers to monitor and analyze the use of our Service, to contact
          You.
        </li>
        <li>
          <strong>For business transfers:</strong>
          <span>&nbsp;</span>We may share or transfer Your personal information
        ...
        <li>
          ...
          <span>&nbsp;</span>We may share Your information with Our affiliates,
        ...
        <li>
          ...
          <span>&nbsp;</span>We may share Your information with Our business
          partners to offer You certain products, services or promotions.
        </li>
        <li>
          <strong>With other users:</strong>
          <span>&nbsp;</span>when You share personal information or otherwise
