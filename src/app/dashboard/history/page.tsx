...
export default function DashboardHistory() {
  ...
  return (
    <div className="m-2 mb-4 py-3 pb-2 flex flex-col gap-2 bg-primary">
          ...
          myTransactions.map((transaction) => {
            return (
              <a
                ...
                // }}
                className="flex flex-col text-sm bg-secondary rounded-md  border-accentSecondary p-2 mx-0 "
