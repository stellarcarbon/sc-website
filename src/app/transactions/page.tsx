...
export default function TransactionsPage() {
  ...
  return (
    <div className="md:flex md:justify-center md:bg-dalle md:bg-cover md:bg-fixed mt-[80px]">
      <main className="bg-secondary min-h-[calc(100vh-176px)] md:border border-tertiary flex flex-col items-center justify-start md:max-w-[700px] xl:max-w-[1000px] md:rounded md:m-6 md:w-[70vw]">
        ...
        <div className="mb-32 p-4 md:p-16 py-16 flex flex-col md:max-w-[1080px] md:mx-auto bg-secondary rounded-md">
          ...
          <div className="tracking-wide leading-7">
            ...
            <p>
              ...
              nostra, per inceptos himenaeos. Nullam viverra fringilla purus, ac
              pellentesque nulla luctus id. Mauris in nisl sapien. Aliquam felis
              libero, blandit id feugiat et, placerat nec tortor. Aliquam
              egestas nunc et pellentesque auctor.
            </p>
          </div>
        </div>
        <Suspense>
